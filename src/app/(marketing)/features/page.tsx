    ...
    <div className="relative w-full">
      ...
      <section className="pt-12 pb-20 sm:pt-20">
        <div className="wb-container text-center">
          ...
          <h1 className="mt-4 font-display text-3xl font-medium leading-[1.1] tracking-tight text-[#2A1A33] sm:text-5xl md:text-6xl lg:text-7xl text-balance animate-wb-fade-up wb-delay-100">
        ...
        <div className="wb-container">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <h2 className="mt-5 font-display text-2xl font-medium tracking-tight text-[#2A1A33] sm:text-4xl md:text-5xl text-balance">
                ...
                <div className="rounded-3xl border border-rose-100 bg-white p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="mt-1 font-sans text-2xl sm:text-4xl font-medium text-[#2A1A33]">₹32,00,000</p>
                    </div>
                ...
                <div className="rounded-3xl border border-rose-100 bg-white p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="mt-1 font-sans text-2xl sm:text-4xl font-medium text-[#2A1A33]">
      ...
      <section id="timeline" className="py-24">
        <div className="wb-container">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="mt-4 font-display text-2xl font-medium tracking-tight text-[#2A1A33] sm:text-4xl md:text-5xl text-balance">
      ...
      <section className="pb-24">
        <div className="wb-container max-w-5xl">
          <div className="relative overflow-hidden rounded-4xl border border-rose-200 bg-white/90 px-8 py-16 text-center shadow-[0_30px_80px_-30px_rgba(232,115,155,0.5)] sm:px-16 sm:py-20">
            ...
            <div className="relative">
              <h2 className="font-display text-2xl font-medium tracking-tight text-[#2A1A33] sm:text-4xl md:text-6xl text-balance">
